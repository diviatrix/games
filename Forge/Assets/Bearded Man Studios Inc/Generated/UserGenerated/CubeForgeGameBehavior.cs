...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class CubeForgeGameBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject.RegisterRpc("InitializeMap", InitializeMap);
			networkObject.RegisterRpc("CreatePrimitive", CreatePrimitive);
			networkObject.RegisterRpc("DestroyPrimitive", DestroyPrimitive);
			networkObject.RegisterRpc("TestMe", TestMe);
